...
module.exports = {
  ...
  execute: async (client, interaction) => {
    ...
    if (!interaction.guild.members.me.permissions.has(PermissionFlagsBits.ModerateMembers)) return await interaction.reply({ content: 'I don\'t have enough permissions to use this command.' });
